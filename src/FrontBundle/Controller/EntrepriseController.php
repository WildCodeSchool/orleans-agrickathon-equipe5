...
use FrontBundle\Entity\Entreprise;
...
class EntrepriseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entreprises = $em->getRepository('FrontBundle:Entreprise')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FrontBundle\Form\EntrepriseType', $entreprise);
    ...
    {
        $deleteForm = $this->createDeleteForm($entreprise);
        $editForm = $this->createForm('FrontBundle\Form\EntrepriseType', $entreprise);
